# Используем чистый официальный образ NVIDIA с CUDA 12.4 и cuDNN
...
# Ставим PyTorch 2.4+ (CUDA 12.4) и жестко фиксируем numpy<2, чтобы избежать крашей
RUN pip3 install --no-cache-dir --upgrade torch torchvision torchaudio "numpy<2" --index-url https://download.pytorch.org/whl/cu124
